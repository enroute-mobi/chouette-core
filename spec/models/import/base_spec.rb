...
RSpec.describe Import::Base, type: :model do
  ...
  describe '.purge_imports' do
    ...
    it 'removes files from imports older than 60 days' do
      file_purgeable = create(:workbench_import, workbench: workbench)
      other_file_purgeable = create(:workbench_import, workbench: other_workbench)
    ...
    it 'removes imports older than 90 days' do
      old_import = create(:workbench_import, workbench: workbench)

      Timecop.freeze(90.days.from_now) do
