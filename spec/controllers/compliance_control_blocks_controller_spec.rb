...
RSpec.describe ComplianceControlBlocksController, type: :controller do
  ...
  let(:compliance_control_block_params) { compliance_control_block.as_json.merge(block_kind: :transport_mode, transport_mode: "funicular", transport_submode: 'undefined') }
