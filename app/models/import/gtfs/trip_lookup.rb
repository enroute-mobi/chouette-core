class Import::Gtfs
  ...
  class TripLookup
    ...
    class AccessibilityAssessments
      def initialize(shape_provider: nil, code_space: code_space)
        @shape_provider = shape_provider
        @code_space = code_space
      end
      ...
      def find_by(wheelchair_accessible:)
        ...
        when '1'
          @accessibility_assessment_wheelchair_accessible ||=
            shape_provider.accessibility_assessments.first_or_create_by_code(code_space, 'gtfs-wheelchair-accessible') do |a|
        ...
        when '2'
          @accessibility_assessment_wheelchair_not_accessible ||=
            shape_provider.accessibility_assessments.first_or_create_by_code(code_space, 'gtfs-wheelchair-not-accessible') do |a|
