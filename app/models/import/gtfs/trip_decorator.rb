  ...
  class Gtfs
    ...
    class TripDecorator < Import::Gtfs::Decorator
        ...
        def validate
          ...
          if flexible?
            if earliest_departure_time_of_day && latest_arrival_time_of_day
              unless earliest_departure_time_of_day < latest_arrival_time_of_day
                errors.add :invalid_pickup_drop_off_window
              end
            else
          ...
          elsif departure_time_of_day && arrival_time_of_day
          ...
          return unless arrival_time_of_day && previous&.departure_time_of_day
      ...
      def starting_day_offset
        ...
        gtfs_first_time = GtfsTime.parse(first_time)
        return 0 unless gtfs_first_time

        @starting_day_offset ||= gtfs_first_time.day_offset
      end

      def route_stops_signature
        skip = true
