RSpec.describe 'Checksum', type: :feature do
 ...
 let(:time_table) do
  ...
  let(:stop_area_1){
    create :stop_area, id: 1, objectid: "FR:1:ZDE:1:STIF", stop_area_referential: stop_area_referential
  }
  let(:stop_area_2){
    create :stop_area, id: 2, objectid: "FR:1:ZDE:2:STIF", stop_area_referential: stop_area_referential
  }
  let(:stop_area_3){
    create :stop_area, id: 3, objectid: "FR:1:ZDE:3:STIF", stop_area_referential: stop_area_referential
  }
