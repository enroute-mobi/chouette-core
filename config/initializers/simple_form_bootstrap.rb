...
SimpleForm.setup do |config|
  ...
  config.button_class = 'btn btn-confirm'
  ...
  config.wrappers :horizontal_form_tailwind, tag: 'div', class: 'flex items-center mb-6', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'w-4/6 flex items-center relative' do |ba|
      ba.use :input, class: 'form-control'
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block small absolute top-8 ml-2' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block small absolute top-8 ml-2' }
    end
  end
  ...
  config.wrappers :horizontal_form_tailwind_right_label, tag: 'div', class: 'flex items-center mb-6', error_class: 'has-error' do |b|
    ...
    b.wrapper tag: 'div', class: 'w-4/6 flex items-center relative' do |ba|
      ...
      ba.use :error, wrap_with: { tag: 'span', class: 'help-block small absolute top-6 ml-2' }
      ba.use :hint,  wrap_with: { tag: 'p', class: 'help-block small absolute top-6 ml-2' }
    end
  end
