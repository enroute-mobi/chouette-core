...
class LineNoticeMembershipDecorator < AF83::Decorator
  ...
  action_link(secondary: true, if: -> { h.policy(context[:line].line_notice_memberships).update? }) do |l|
    l.content { I18n.t('line_notice_memberships.actions.edit') }
  ...
  with_instance_decorator do |instance_decorator|
    ...
    instance_decorator.action_link if: -> { h.policy(object.line_notice).update? } do |l|
      l.content { I18n.t('line_notices.actions.edit') }
    ...
    instance_decorator.action_link if: -> { h.policy(object.line_notice).destroy? } do |l|
      l.content { I18n.t('line_notices.actions.destroy') }
      l.href { [context[:workbench], :line_referential, object.line_notice] }
      l.method :delete
      l.icon 'trash'
      l.icon_class :danger
      l.confirm { I18n.t('line_notices.actions.destroy_confirm') }
    end
