...
class Export::Base < ApplicationModel
  ...
  class Scope < SimpleDelegator
    ...
    delegate :stop_area_referential, :line_referential, :fare_referential, :workbench, :workgroup, to: :export
  ...
  def code_provider
    @code_provider ||= Export::CodeProvider.new(export_scope, **code_provider_options)
  end
