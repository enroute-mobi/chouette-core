    ...
    describe "Stops" do
      ...
      describe "csv_headers" do
        ...
        it "uses a static header definition" do
          ...
          is_expected.to eq(%w{id vehicle_journey_id stop_point_id arrival_time departure_time departure_day_offset arrival_day_offset checksum checksum_source stop_area_id earliest_departure_time_of_day latest_arrival_time_of_day})
        end
