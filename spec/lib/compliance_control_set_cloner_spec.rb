  ...
  context 'Copying empty set' do
    ...
    context 'correct organisation' do
      ...
      context 'Directed Acyclic Graph is copied correctly' do
        ...
        let(:direct_ccs){
          out = 3.times.map{ |n| create :generic_attribute_control_pattern, compliance_control_set: source_set, name: "direct #{n.succ}", code: "direct-#{n.succ}" }
        ...
        let(:indirect_ccs){
          ...
          source_blox.each_with_index.map{ | source_block, n |
            create(:generic_attribute_control_pattern, compliance_control_set: source_set, compliance_control_block: source_block, name: "indirect #{n.succ}", code: "indirect-#{n.succ}")
          }
        }
