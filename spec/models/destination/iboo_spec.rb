...
RSpec.describe Destination::Iboo, type: :model do
  subject(:destination) do
    Destination::Iboo.create!(
      name: 'Iboo Saas',
  ...
  describe '#transmit' do
    ...
    before do
      ...
      allow_any_instance_of(Destination::Iboo).to(
