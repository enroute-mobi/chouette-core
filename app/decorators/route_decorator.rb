class RouteDecorator < AF83::Decorator
  ...
  with_instance_decorator do |instance_decorator|
    ...
    instance_decorator.action_link(
      ...
      l.content { I18n.t('journey_patterns.actions.index') }
      l.href do
        [
          context[:workbench],
          context[:referential],
    ...
    instance_decorator.action_link(
      ...
      l.content { I18n.t('vehicle_journeys.actions.index') }
      l.href do
        [
          context[:workbench],
          context[:referential],
    ...
    instance_decorator.action_link(
      ...
      l.content { I18n.t('routes.duplicate.title') }
      l.method :post
      l.href do
    ...
    instance_decorator.action_link(
      ...
      l.content { I18n.t('routes.create_opposite.title') }
      l.method :post
